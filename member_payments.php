...
<head>
    <meta charset="UTF-8">
    <title>مدفوعاتي - جمعية السعدي</title>
    ...
    <div class="dashboard-layout">
        <aside class="member-sidebar">
            ...
            <ul class="member-sidebar-menu">
                ...
                <li><a href="member_payments.php" class="active"><span class="icon">💳</span> مدفوعاتي</a></li>
            </ul>
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $pay['subscription_year']; ?></td>
                        ...
                        ?>
                        <tr>
                            <td colspan="6" style="text-align: center; padding: 30px; color: #5a6c7d;">
