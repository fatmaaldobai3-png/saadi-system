...
<body class="login-page">
    <div class="login-box">
        <img src="images/logo.jpg" alt="شعار جمعية السعدي" style="width: 80px; height: 80px; border-radius: 50%; margin: 0 auto 15px; display: block; border: 3px solid var(--secondary);">
        <h2>لوحة الإدارة</h2>
